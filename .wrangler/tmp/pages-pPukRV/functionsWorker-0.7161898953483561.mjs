...
var onRequestGet = /* @__PURE__ */ __name(async (ctx) => {
  ...
  try {
    ...
    console.error("Error fetching alert.pb:", error3);
    return new Response(
      `Proxy error: ${error3 instanceof Error ? error3.message : "Unknown error"}`,
      {
        status: 502,
        headers: {
          "Content-Type": "text/plain; charset=utf-8",
...
var onRequestGet2 = /* @__PURE__ */ __name(async (ctx) => {
  ...
  try {
    ...
    console.error("Error fetching route.pb:", error3);
    return new Response(
      `Proxy error: ${error3 instanceof Error ? error3.message : "Unknown error"}`,
      {
        status: 502,
...
var onRequestGet3 = /* @__PURE__ */ __name(async (ctx) => {
  ...
  try {
    ...
    console.error("Error fetching vehicle.pb:", error3);
    return new Response(
      `Proxy error: ${error3 instanceof Error ? error3.message : "Unknown error"}`,
      {
        status: 502,
...
// ../.wrangler/tmp/pages-pPukRV/functionsRoutes-0.695972822699781.mjs
var routes = [
  {
    routePath: "/api/alert",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-redkCx/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-redkCx/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7161898953483561.mjs.map
