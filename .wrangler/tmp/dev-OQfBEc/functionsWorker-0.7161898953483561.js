...
// .wrangler/tmp/pages-pPukRV/functionsWorker-0.7161898953483561.mjs
...
var onRequestGet = /* @__PURE__ */ __name2(async (ctx) => {
  ...
  try {
    ...
    console.error("Error fetching alert.pb:", error32);
    return new Response(
      `Proxy error: ${error32 instanceof Error ? error32.message : "Unknown error"}`,
      {
        status: 502,
        headers: {
          "Content-Type": "text/plain; charset=utf-8",
...
var onRequestGet2 = /* @__PURE__ */ __name2(async (ctx) => {
  ...
  try {
    ...
    console.error("Error fetching route.pb:", error32);
    return new Response(
      `Proxy error: ${error32 instanceof Error ? error32.message : "Unknown error"}`,
      {
        status: 502,
...
var onRequestGet3 = /* @__PURE__ */ __name2(async (ctx) => {
  ...
  try {
    ...
    console.error("Error fetching vehicle.pb:", error32);
    return new Response(
      `Proxy error: ${error32 instanceof Error ? error32.message : "Unknown error"}`,
      {
        status: 502,
...
// .wrangler/tmp/bundle-IdzWcr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-IdzWcr/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7161898953483561.js.map
