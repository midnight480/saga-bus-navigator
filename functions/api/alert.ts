/**
 * Cloudflare Functions: alert.pbプロキシ
 * 
 * 佐賀バスオープンデータのalert.pb（運行情報）を
...
/**
 * GETリクエストハンドラー（alert.pbの取得、デコード、JSON形式で返却）
 */
export const onRequestGet = async (ctx: any) => {
  ...
  try {
    ...
    // ネットワークエラーやデコードエラーなど
    console.error("Error fetching/decoding alert.pb:", error);
    return new Response(
